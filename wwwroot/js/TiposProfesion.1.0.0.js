            ...
            $.each(TiposProfesion, function (index, Profesion) {
                ...
                {Profesion.profesionID
                    ...
                    <tr>
                        ...
                        <td>
                                 <button type="button" class="btn btn-outline-success me-2" onclick="AbrirModalEditar(${Profesion.profesionID})">
      <i class="fa-regular fa-pen-to-square"></i> Editar
    </button></td>
     <td> <button type="button" class="btn btn-outline-danger" onclick="EliminarProfesion(${Profesion.profesionID})">
