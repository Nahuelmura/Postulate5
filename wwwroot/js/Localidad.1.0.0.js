        ...
        success: function (Localidades) {
            ...
            $.each(Localidades, function (index, Localidad) {

                {
                    ...
                    contenidoTabla += `
                         <tr>
                        <td class="ocultar-en-550px ocultar-en-768px">${Localidad.provinciaNombre}</td>
                        <td>${Localidad.nombre}</td>
                        <td class="ocultar-en-550px ocultar-en-768px"> ${Localidad.codigoPostal}</td>
                        <td>
                            <button type="button" class="btn btn-outline-success me-2" onclick="AbrirModalEditar(${Localidad.localidadID})">
                                <i class="fa-regular fa-pen-to-square"></i> Editar
                            </button>
                        </td>
                        <td>
                            <button type="button" class="btn btn-outline-danger" onclick="EliminarLocalidad(${Localidad.localidadID})">
