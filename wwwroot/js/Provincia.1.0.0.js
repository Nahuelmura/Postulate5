            ...
            $.each(Provincias, function (index, Provincia) { 
                ...
                contenidoTabla += `
                    <tr>
                        ...
                        <td>
                  <button type="button" class="btn btn-outline-success me-2" onclick="AbrirModalEditar(${Provincia.provinciaID})">
      <i class="fa-regular fa-pen-to-square"></i> Editar
    </button></td>
     <td> <button type="button" class="btn btn-outline-danger" onclick="EliminarProvincia(${Provincia.provinciaID})">
